...
static void ICACHE_FLASH_ATTR crc32_init_context(struct crc32_context *context)
{
    context->crc = 0xffffffffU;
}

static void ICACHE_FLASH_ATTR crc32_step(struct crc32_context *context, uint8_t byte)
{
    context->crc ^= byte;
...
static uint32_t ICACHE_FLASH_ATTR crc32_finalize(struct crc32_context *context)
{
    return ~context->crc;
}


static void ICACHE_FLASH_ATTR stuffed_tx_byte(struct min_context *self, uint8_t byte)
{
    // Transmit the byte
...
static void ICACHE_FLASH_ATTR on_wire_bytes(struct min_context *self, uint8_t id_control, uint8_t seq, uint8_t *payload_base, uint16_t payload_offset, uint16_t payload_mask, uint8_t payload_len)
{
    uint8_t n, i;
    uint32_t checksum;
...
static void ICACHE_FLASH_ATTR transport_fifo_pop(struct min_context *self)
{
...
static struct ICACHE_FLASH_ATTR transport_frame *transport_fifo_push(struct min_context *self, uint16_t data_size)
{
...
static struct ICACHE_FLASH_ATTR transport_frame *transport_fifo_get(struct min_context *self, uint8_t n)
{
...
static void ICACHE_FLASH_ATTR transport_fifo_send(struct min_context *self, struct transport_frame *frame)
{
...
static void ICACHE_FLASH_ATTR send_ack(struct min_context *self)
{
...
static void ICACHE_FLASH_ATTR send_reset(struct min_context *self)
{
...
static void ICACHE_FLASH_ATTR transport_fifo_reset(struct min_context *self)
{
...
void ICACHE_FLASH_ATTR min_transport_reset(struct min_context *self)
{
...
bool ICACHE_FLASH_ATTR min_queue_frame(struct min_context *self, uint8_t min_id, uint8_t *payload, uint8_t payload_len)
{
...
static struct ICACHE_FLASH_ATTR transport_frame *find_retransmit_frame(struct min_context *self)
{
...
static void ICACHE_FLASH_ATTR valid_frame_received(struct min_context *self)
{
...
static void ICACHE_FLASH_ATTR rx_byte(struct min_context *self, uint8_t byte)
{
...
void ICACHE_FLASH_ATTR min_poll(struct min_context *self, uint8_t *buf, uint32_t buf_len)
{
...
void ICACHE_FLASH_ATTR min_init_context(struct min_context *self, uint8_t port)
{
    // Initialize context
    self->rx_header_bytes_seen = 0;
    self->rx_frame_state = SEARCHING_FOR_SOF;
...
void ICACHE_FLASH_ATTR min_send_frame(struct min_context *self, uint8_t min_id, uint8_t *payload, uint8_t payload_len)
{
